...
public class Board {
	...
	/**
	 * Sets tile numbers from 0 to 224 and values 
	 * none(N), double letter (DL), double word (DW), triple letter (TL), triple word (TW), center tile (C)
	 */
	
	private void setTileNumbersAndValues() {
		ArrayList<Integer> tripleWordTiles = new ArrayList<>(Arrays.asList(0,7,14,105,119,210,217,224));
		ArrayList<Integer> tripleLetterTiles = new ArrayList<>(Arrays.asList(20,24,76,80,84,88,136,140,144,148,200,204));
		ArrayList<Integer> doubleWordTiles = new ArrayList<>(Arrays.asList(16,28,32,42,48,56,64,70,154,160,168,176,182,208));
		ArrayList<Integer> doubleLetterTiles = new ArrayList<>(Arrays.asList(3,11,36,38,45,52,59,92,96,98,102,108,116,122,126,128,132,165,172,179,186,188,213,221));	
		for (int i = 0; i < 225; i++) {
